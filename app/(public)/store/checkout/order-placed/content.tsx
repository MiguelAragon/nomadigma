...
import { Info } from '@/app/(public)/store/checkout/order-placed/components/info';
import { Payment } from '@/app/(public)/store/checkout/order-placed/components/payment';
import { Order } from '@/app/(public)/store/checkout/order-summary/components/order';
